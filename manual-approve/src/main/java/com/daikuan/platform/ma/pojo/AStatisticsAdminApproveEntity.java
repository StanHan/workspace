...
/**
 * @author feizy
 * @version AStatisticsAdminApproveEntity, v0.1 2017/3/29 11:54
 */
@Table(name = "a_statistics_admin_approve")
public class AStatisticsAdminApproveEntity {
    @Id
    ...
    public String toString() {
        return "AStatisticsAdminApproveEntity{" +
                "id=" + id +
                ", productId=" + productId +
                ", adminId=" + adminId +
                ", adminName='" + adminName + '\'' +
