...
/**
 * @author feizy
 * @version ProductApproveStatisticsVO, v0.1 2017/3/27 20:42
 */
public class ProductApproveStatisticsVO {
    ...
    public String toString() {
        return "ProductApproveStatisticsVO{" + "productId=" + productId + ", claimAmt=" + claimAmt + ", approveAmt="
                + approveAmt + ", agreeTaskAmt=" + agreeTaskAmt + ", agreeCustomerAmt=" + agreeCustomerAmt
                + ", rejectTaskAmt=" + rejectTaskAmt + ", rejectCustomerAmt=" + rejectCustomerAmt + ", autoPassAmt="
                + autoPassAmt + ", autoPassCustomerAmt=" + autoPassCustomerAmt + '}';
    }
}
