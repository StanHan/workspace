...
public class AUserProductAuditEntity implements Serializable {
    ...
    private Integer faceScoreIcon;

    /** 视频人脸比对分数 face_score_video **/
    private Integer faceScoreVideo;
    ...
    public Integer getFaceScoreIcon() {
        return faceScoreIcon;
    }

    public void setFaceScoreIcon(Integer faceScoreIcon) {
        this.faceScoreIcon = faceScoreIcon;
    }

    public Integer getFaceScoreVideo() {
        return faceScoreVideo;
    }

    public void setFaceScoreVideo(Integer faceScoreVideo) {
    ...
    public String toString() {
        return "AUserProductAuditEntity{" +
                "id=" + id +
                ", userId=" + userId +
                ", applyId=" + applyId +
                ", idNo='" + idNo + '\'' +
