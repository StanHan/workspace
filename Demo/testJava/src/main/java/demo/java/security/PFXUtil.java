...
public class PFXUtil {
    ...
    private static KeyFactory getKeyFactory() throws Exception {
        return getKeyFactory(RSA.KEY_ALGORITHM);
    }
     ...
     * @throws Exception
     */
    public static String generatorPFX(PrivateKey privateKey, X509Certificate x509Certificate, String password,
    ...
    public static void main(String[] args) throws Exception {
        String pfxPath = "G:\\logs\\EVA_TEST.pfx";
        ...
        // PFX：合成pfx（需要私钥、公钥证书）
        String savePath = generatorPFX(privateKey, certificate, password, new File("G:\\logs\\009.pfx"));
