...
import demo.java.sql.jdbc.pool.TomcatDataSourceDemo;
...
public class DataSourceDemo {
    ...
    public static DataSource xyj = TomcatDataSourceDemo.getMySqlDataSource(url, user, pass);

    public static DataSource mycat = TomcatDataSourceDemo.getMySqlDataSource(url2, user2, pass2);

    public static DataSource local = TomcatDataSourceDemo.getMySqlDataSource(localUrl, localUser, localPass);
